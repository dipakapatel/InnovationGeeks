            ...
            <div class="form-validation">
                  <form class="form-valide" action="change_password.php" method="post" enctype="multipart/form-data">
                    <div class="form-group row col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" id="val-oldpassword" name="val-oldpassword" placeholder="Enter a your old Password.."/>
                        </div>
                    </div>
                    <div class="form-group row col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" id="val-password" name="val-password" placeholder="Enter a new Password.."/>
                        </div>
                    </div>
                    <div class="form-group row col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" id="val-confirm-password" name="val-confirm-password" placeholder="Re-type your new Password.."/>
                        </div>
                    </div>
                    <div class="form-group row col-lg-12">
