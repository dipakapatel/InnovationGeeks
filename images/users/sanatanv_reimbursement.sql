...
--
-- Host: localhost:3306
-- Generation Time: Jun 04, 2018 at 11:21 AM
...
--
-- Database: `sanatanv_reimbursement`
--
...
(26, 'ICT709 ATMC Course Outline Sem 1 2018 (1).pdf', 'application/pdf', 'uploads/reimburse/17305044.pdf', 18);
...
(13, 1010124, 2, 230, '03-05-2018', 'Travel expense', '1', '2018-05-08 01:34:22', 1),
...
(17, 1010124, 3, 200, '01-05-2018', 'hello', '0', '2018-05-14 04:47:40', 1),
(18, 1010130, 2, 2000, '16-05-2018', 'Description', '0', '2018-05-15 01:19:41', 0);
...
('1010124', 'Tom Cruise', 'HRM', 'tomcruise@yahoo.com', 'admin', 'admin', 'IT Department', '0', 0),
...
('1010127', 'Peter Parker', 'Marketing', 'peter@ibibo.com', 'peter777', 'palak', 'Marketing', '1', 0),
('1010128', 'Irfan Pathan ', 'Development', 'ypathan@ipl.com', 'yusufpathan', '89898989', 'Web Designer', '0', 0),
('1010129', 'Ricky Ponting', 'HRM', 'rickymart@gmail.com', 'rickyponting', 'poipoipo', 'HR Department', '0', 0),
('1010130', 'New Employee', 'Marketing', 'emp@employee.com', 'employee', '1234567', 'General Manager', '0', 0),
('1010131', 'Steve smith', 'Marketing', 'Steve@apple.com', 'Steve777', '123456', 'Marketing', '0', 0);
...
CREATE TABLE `log_table` (
  ...
  `userid` varchar(30) NOT NULL,
  `time_detail` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
